    ...
    LSdata.forEach((element) => {
      let productHTML = `
            <div class="col-6 col-sm-4 col-md-2">
                <button type="button" class="px-4 py-2 rounded-3 text-white bg-primary border-0 fw-bold position-relative" style="letter-spacing: 1px;">
                  ${element.name}
                  <span
                    class="
                      position-absolute
            ...
            `;
      boxToShow.innerHTML = boxToShow.innerHTML + productHTML;
    });
  } else {
    boxToShow.innerHTML = `<div class="alert alert-primary" role="alert">
